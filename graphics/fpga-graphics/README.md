...
This folder contains SystemVerilog designs to accompany the Project F blog post: **[FPGA Graphics](https://projectf.io/posts/fpga-graphics/)**. The designs teach demonstrate how displays work and show you how to draw your first FPGA graphics. You can freely build on these [MIT licensed](../../LICENSE) designs for commercial and non-commercial projects. Have fun.
...
_Image generated by a Artix-7 FPGA using the top_bounce demo._
