# Project F: Hardware Sprites - Create Vivado Project (XC7 DVI)
...
set _xil_proj_name_ "hardware-sprites-dvi"
...
set top_sources [list \
  [file normalize "${origin_dir}/xc7-dvi/top_hedgehog.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_hourglass.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_tinyf_inline.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_tinyf_move.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_tinyf_rom.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_tinyf_scale.sv"] \
]
