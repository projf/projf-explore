# Project F: Simple 3D - Create Vivado Project (Nexys Video)
# (C)2021 Will Green, open source hardware released under the MIT License
# Learn more at https://projectf.io

puts "INFO: Project F - Simple 3D Project Creation Script"
...
set _xil_proj_name_ "simple-3d-hd"
...
set top_sources [list \
  [file normalize "${origin_dir}/xc7-hd/top_icosphere.sv"] \
]
...
set_property -name "top" -value "top_icosphere" -objects $fs_design_obj
