...
This folder contains designs to accompany the Project F blog post: **[Exploring FPGA Graphics](https://projectf.io/posts/fpga-graphics/)**.
...
```bash
cd projf-explore/graphics/exploring-graphics/ice40
make top_bounce
```
...
```tcl
cd projf-explore/graphics/exploring-graphics/xc7/vivado
...
```bash
$ ./exploring-graphics/lint.sh
## Linting top modules in ./exploring-graphics/xc7
##   Checking ./exploring-graphics/xc7/top_beam.sv
##   Checking ./exploring-graphics/xc7/top_bounce.sv
##   Checking ./exploring-graphics/xc7/top_square.sv
## Linting top modules in ./exploring-graphics/ice40
##   Checking ./exploring-graphics/ice40/top_beam.sv
##   Checking ./exploring-graphics/ice40/top_bounce.sv
##   Checking ./exploring-graphics/ice40/top_square.sv
```
