# Project F: Ad Astra - Create Vivado Project (Nexys Video)
...
set _xil_proj_name_ "ad-astra-hd"
...
set top_sources [list \
  [file normalize "${origin_dir}/xc7-hd/top_greet.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_greet_v1.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_lfsr.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_hello_en.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_hello_jp.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_space_f.sv"] \
  [file normalize "${origin_dir}/xc7-hd/top_starfields.sv"] \
]
