...
set top_sources [list \
  [file normalize "${origin_dir}/xc7-dvi/top_david_16colr.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_david_mono.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_david_scale.sv"] \
  [file normalize "${origin_dir}/xc7-dvi/top_david_fizzle.sv"] \
]
...
set_property -name "top" -value "top_david_scale" -objects $fs_design_obj
...
set mem_design_sources [list \
  ...
  [file normalize "${lib_dir}/res/palettes/greyinvert16_4b.mem"] \
  [file normalize "${lib_dir}/res/palettes/sepia16_4b.mem"] \
