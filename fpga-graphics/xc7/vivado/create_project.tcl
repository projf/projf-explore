...
set sim_sources [list \
  [file normalize "${common_dir}/xc7/clock_gen_480p_tb.sv"] \
  [file normalize "${origin_dir}/xc7/display_timings_480p_tb.sv"] \
  [file normalize "${origin_dir}/xc7/vivado/clock_gen_480p_tb_behav.wcfg"] \
  [file normalize "${origin_dir}/xc7/vivado/display_timings_480p_tb_behav.wcfg"] \
]
