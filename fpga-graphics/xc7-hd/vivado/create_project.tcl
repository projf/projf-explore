...
set sim_sources [list \
  [file normalize "${origin_dir}/xc7-hd/display_timings_720p_tb.sv"] \
  [file normalize "${origin_dir}/xc7-hd/display_timings_1080p_tb.sv"] \
  [file normalize "${origin_dir}/xc7-hd/vivado/display_timings_720p_tb_behav.wcfg"] \
  [file normalize "${origin_dir}/xc7-hd/vivado/display_timings_1080p_tb_behav.wcfg"] \
]
add_files -norecurse -fileset $fs_sim_obj $sim_sources

# Set 'sim_1' fileset properties
set_property -name "top" -value "display_timings_720p_tb" -objects $fs_sim_obj
