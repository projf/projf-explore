...
set _xil_proj_name_ "framebuffers-hd"
...
set mem_design_sources [list \
  ...
  [file normalize "${common_dir}/res/test/test_box_mono_160x120.mem"] \
...
set sim_sources [list \
  ...
  [file normalize "${origin_dir}/xc7/vivado/framebuffer_tb_behav.wcfg" ] \
  [file normalize "${origin_dir}/xc7/vivado/linebuffer_tb_behav.wcfg" ] \
]
