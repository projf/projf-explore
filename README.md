...
The Project F Library includes handy Verilog designs for everyone. From framebuffers and video output, to division and square root, rom and ram, and even drawing shapes. You can freely build on these [MIT licensed](LICENSE) designs for commercial and non-commercial projects.
