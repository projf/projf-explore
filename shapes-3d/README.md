...
This folder contains SystemVerilog designs to accompany the Project F blog post: **[Shapes & Simple 3D](https://projectf.io/posts/shapes-3d/)**.
...
```tcl
cd projf-explore/shapes-3d/xc7/vivado
