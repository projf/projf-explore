# Project F: Rasterbars - Create Vivado Project
# (C)2022 Will Green, open source hardware released under the MIT License
# Learn more at https://projectf.io/posts/rasterbars/

puts "INFO: Project F - Rasterbars Project Creation Script"
...
set _xil_proj_name_ "rasterbars"
...
set top_sources [list \
  ...
  [file normalize "${origin_dir}/render_rasterbars.sv"] \
  [file normalize "${origin_dir}/rasterbar.sv"] \
]
