...
int main(int argc, char* argv[]) {
    ...
    sdl_window = SDL_CreateWindow("Maths Graphing Demo", SDL_WINDOWPOS_CENTERED,
    ...
    while (1) {
        ...
        // update texture once per frame at start of each frame (in blanking)
        if (top->frame) {
